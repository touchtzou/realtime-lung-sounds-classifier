...
% pathological subjects using the leave-one-out method. The feature vectors
% of the pathological lung sounds are organized, according to the order
% listed below in the vector named 's', in a MAT file named 'pathology.mat'.

class_name=2;
   
   s=['Enter the number of pathological subject you want to classify?\n'...
     	,'1.ad_sa4','\n2.ali_du2','\n3.ar_kul1'...
     	,'\n4.ay_ak4','\n5.ca_sa3','\n6.do_bi4','\n7.fa_sa1'...
     	,'\n8.ga_ka5','\n9.gu_il3','\n10.ha_ay3','\n11.ha_de4'...
     	,'\n12.ha_oz4','\n13.ha_sa2','\n14.ha_yi5','\n15.is_co2'...
...
% the pathological subject features except the excluded one.
%****************************************************************
subject_start=1;
subject_end=subject_start+(60*(lpc_order+2))-1;
...
% These features are the ones to be used to represent the pathol. class
...
%  the pathol. class after excluding the subject to be classified.
%*****************************************************************
...
% matrices that represent the 'healthy class'.
%*****************************************************************

user_select=0;
   load healthy.mat; % Load workspace variables.
   total_sub_features=subject_features;
   subject_number=21; % A total of 21 healthy resp. cycles.
starting=1;
ending=starting+lpc_order+1;
subject_features=total_sub_features;	% Select all subjects.
...
% These features are the scaled ones that represent the healthy class and that are
...
%*******************************************************************
% Output the mean LPC coeffs. that belong to the healthy class
%*******************************************************************
%beta_early_insp_hlt
%beta_mid_insp_hlt
%beta_late_insp_hlt
...
%*******************************************************************
%HEALTY_inverse_of_early_insp_covariance=W_early_insp_hlt(1:(lpc_order+1)*(lpc_order+1))'
%HEALTY_inverse_of_mid_insp_covariance=W_mid_insp_hlt(1:(lpc_order+1)*(lpc_order+1))'
%HEALTY_inverse_of_late_insp_covariance=W_late_insp_hlt(1:(lpc_order+1)*(lpc_order+1))'
%HEALTY_inverse_of_early_exp_covariance=W_early_exp_hlt(1:(lpc_order+1)*(lpc_order+1))'
%HEALTY_inverse_of_mid_exp_covariance=W_mid_exp_hlt(1:(lpc_order+1)*(lpc_order+1))'
%HEALTY_inverse_of_late_exp_covariance=W_late_exp_hlt(1:(lpc_order+1)*(lpc_order+1))'
